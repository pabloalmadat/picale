...
const BRANDS = {
  ...
  picale: { name: "Pícale", logoUrl: PICALE_LOGO },
};
    ...
    <div className="wrap">
      <div className="mp-head">
        ...
        <div className="mp-meta">
          ...
          <span>·</span><span>Transmisión y tecnología por</span><PicaleMark height={16} />
        </div>
        {live.length > 0 && (
        ...
        <div className="wrap nav-in">
          ...
          <div className="nav-right">
            ...
            <span className="picale-tag">
              Powered by <PicaleMark height={17} />
            </span>
